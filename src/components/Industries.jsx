        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {verticals.map((v, idx) => {
            ...
            return (
              <div 
                key={idx}
                className="glass-card p-8 flex flex-col justify-between relative group hover:border-[#ff5500]/50"
              >
                <div>
                  ...
                  <h3 className="text-2xl font-extrabold text-white mb-2 font-['Outfit']">
                    {v.title}
                  </h3>
                ...
                <button 
                  onClick={onOpenModal}
                  className="mt-8 w-full py-3 rounded-xl bg-slate-900 hover:bg-[#ff5500] text-slate-300 hover:text-white font-bold text-sm flex items-center justify-center gap-2 border border-slate-800 hover:border-[#ff5500] transition-all group-hover:shadow-lg"
                >
